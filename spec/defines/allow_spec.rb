  ...
  on_os_under_test.each do |os, facts|
    context "on #{os}" do
      ...
      context 'specifying port' do
        ...
        it do
          is_expected.to contain_exec('ufw-allow-IN-tcp-from-any-to-192.168.42.42-port-8080').
      ...
      context 'specifying port for any protocol' do
        let(:params) { { port: '8080' } }
        it do
          is_expected.to contain_exec('ufw-allow-IN-any-from-any-to-192.168.42.42-port-8080').
      ...
      context 'with ensure => absent' do
        ...
        it do
          is_expected.to contain_exec('ufw-delete-tcp-from-any-to-192.168.42.42-port-all').
