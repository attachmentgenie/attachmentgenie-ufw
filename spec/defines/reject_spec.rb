...
describe 'ufw::reject', :type => :define do
  ...
  context 'basic operation' do
    it { should contain_exec('ufw-reject-IN-tcp-from-any-to-any-port-all').
  ...
  context 'specifying from address' do
    ...
    it { should contain_exec('ufw-reject-IN-tcp-from-192.0.2.42-to-any-port-all').
  ...
  describe 'specifying to address' do
    ...
    context 'from $ip parameter' do
      ...
      it { should contain_exec('ufw-reject-IN-tcp-from-any-to-192.0.2.68-port-all').
    ...
    context 'from $ip parameter (ipv6)' do
      ...
      it { should contain_exec('ufw-reject-IN-tcp-from-any-to-2a00:1450:4009:80c::1001-port-all').
  ...
  context 'specifying port' do
    ...
    it { should contain_exec('ufw-reject-IN-tcp-from-any-to-any-port-8080').
